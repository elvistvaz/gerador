...
export class IndicadorListComponent implements OnInit {
  ...
  novo(): void {
    ...
    if (Object.keys(this.parentFilter).length > 0) {
      this.router.navigate(['/indicador/novo'], { queryParams: this.parentFilter });
    } else {
      this.router.navigate(['/indicador/novo']);
    }
  }

  editar(id: number): void {
    this.router.navigate(['/indicador/editar', id]);
  }
