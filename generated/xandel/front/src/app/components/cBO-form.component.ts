...
import { CBORequest, CBOResponse } from '../models/cBO.model';
import { CBOService } from '../services/cBO.service';

@Component({
  selector: 'app-cBO-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cBO-form.component.html',
  styleUrls: ['./cBO-form.component.css']
})
export class CBOFormComponent implements OnInit {

  item: CBORequest = {} as CBORequest;
  ...
  private navegarParaLista(): void {
    if (Object.keys(this.returnQueryParams).length > 0) {
      this.router.navigate(['/cBO'], { queryParams: this.returnQueryParams });
    } else {
