...
import { CidadeList } from '../models/cidade.model';
...
export class CidadeListComponent implements OnInit {
  ...
  novo(): void {
    ...
    if (Object.keys(this.parentFilter).length > 0) {
      this.router.navigate(['/cidade/novo'], { queryParams: this.parentFilter });
    } else {
  ...
  editar(id: number): void {
    this.router.navigate(['/cidade/editar', id]);
  }
