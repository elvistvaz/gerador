...
import { OperadoraList } from '../models/operadora.model';
...
export class OperadoraListComponent implements OnInit {
  ...
  novo(): void {
    ...
    if (Object.keys(this.parentFilter).length > 0) {
      this.router.navigate(['/operadora/novo'], { queryParams: this.parentFilter });
    } else {
      this.router.navigate(['/operadora/novo']);
    }
  }

  editar(id: number): void {
    this.router.navigate(['/operadora/editar', id]);
  }
