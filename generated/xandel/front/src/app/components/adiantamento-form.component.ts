...
import { AdiantamentoRequest, AdiantamentoResponse } from '../models/adiantamento.model';
import { AdiantamentoService } from '../services/adiantamento.service';
import { SessionService } from '../services/session.service';

@Component({
  selector: 'app-adiantamento-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './adiantamento-form.component.html',
  styleUrls: ['./adiantamento-form.component.css']
})
export class AdiantamentoFormComponent implements OnInit {

  item: AdiantamentoRequest = {} as AdiantamentoRequest;
  ...
  loadItem(): void {
    ...
    this.service.findById(this.id).subscribe({
      next: (data) => {
        this.item = data as AdiantamentoRequest;
        this.loading = false;
      },
      error: (err) => {
  ...
  private navegarParaLista(): void {
    if (Object.keys(this.returnQueryParams).length > 0) {
      this.router.navigate(['/adiantamento'], { queryParams: this.returnQueryParams });
    } else {
