...
import { NFRequest, NFResponse } from '../models/nF.model';
...
export class NFFormComponent implements OnInit {
  ...
  private navegarParaLista(): void {
    if (Object.keys(this.returnQueryParams).length > 0) {
      this.router.navigate(['/nF'], { queryParams: this.returnQueryParams });
    } else {
