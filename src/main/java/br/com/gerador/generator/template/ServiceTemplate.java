...
public class ServiceTemplate {
    ...
    public String generate(Entity entity) {
        ...
        if (hasSessionFilter) {
            ...
            // Verifica se os campos de filtro fazem parte da chave composta
            boolean filterFieldIsPartOfCompositePk = false;
            boolean filterField2IsPartOfCompositePk = false;
            for (Field field : entity.getFields()) {
                if (field.getName().equals(filterField) && hasCompositeKey && field.isPrimaryKey()) {
                    filterFieldIsPartOfCompositePk = true;
                }
                if (filterField2 != null && field.getName().equals(filterField2) && hasCompositeKey && field.isPrimaryKey()) {
                    filterField2IsPartOfCompositePk = true;
                }
            }
