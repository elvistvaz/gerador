@echo off
echo ================================================================
echo   GERADOR ICEP - Laravel Full Stack
echo ================================================================
echo.
echo   Inicio: %TIME%
echo.
...
echo   OK - Porta 8000 liberada [%TIME%]
echo.
...
if exist "generated\icep-laravel" (
    rmdir /S /Q "generated\icep-laravel"
...
REM ==============================================================
REM [4/8] Gerando projeto ICEP Laravel
REM ==============================================================
echo [4/8] Gerando projeto ICEP Laravel...
call "C:\Program Files\Apache\apache-maven-3.9.11\bin\mvn.cmd" -f pom.xml exec:java -Dexec.mainClass="br.com.gerador.generator.UnifiedGeneratorMain" -Dexec.args="icep" -q
if errorlevel 1 (
...
echo.
echo   Carregando dados iniciais (3.101 registros)...
...
echo.
echo   Projeto gerado em: generated\icep-laravel
echo.
echo   Para executar o projeto, use:
echo     executar_icep.bat
echo.
pause
